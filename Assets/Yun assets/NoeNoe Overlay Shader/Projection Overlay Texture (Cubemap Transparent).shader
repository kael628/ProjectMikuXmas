...
////// Lighting:
                ...
                float4 _Cubemap_var = texCUBE(_Cubemap,float3(node_7256.r,(node_7256.g*(-1.0)),node_7256.b));
                ...
                float node_4857 = 3.0;
                float3 finalColor = (lerp(lerp(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),dot(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),float3(0.3,0.59,0.11)),(-0.5)),dot(lerp(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),dot(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),float3(0.3,0.59,0.11)),(-0.5)),float3(0.3,0.59,0.11)),(1.0 - _Color.a))*saturate((saturate((Function_node_3693( float3(0,1,0) )+(_LightColor0.rgb*attenuation)))*floor(saturate((dot(_Ramp_var.rgb,float3(0.3,0.59,0.11))+0.8)) * node_4857) / (node_4857 - 1)))*_Intensity);
                return fixed4(finalColor,(_MainTex_var.a*_Cubemap_var.a*_Opacity));
            }
            ENDCG
        }
        Pass {
...
////// Lighting:
                ...
                float node_4857 = 3.0;
                float3 finalColor = (lerp(lerp(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),dot(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),float3(0.3,0.59,0.11)),(-0.5)),dot(lerp(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),dot(((lerp(float3(node_9970,node_9970,node_9970),_Cubemap_var.rgb,saturate(_CrossfadeOverlay))*lerp(float3(node_9970,node_9970,node_9970),_MainTex_var.rgb,saturate((node_9970+(1.0 - _CrossfadeOverlay)))))*_Color.rgb*1.0),float3(0.3,0.59,0.11)),(-0.5)),float3(0.3,0.59,0.11)),(1.0 - _Color.a))*saturate((saturate((Function_node_3693( float3(0,1,0) )+(_LightColor0.rgb*attenuation)))*floor(saturate((dot(_Ramp_var.rgb,float3(0.3,0.59,0.11))+0.8)) * node_4857) / (node_4857 - 1)))*_Intensity);
                return fixed4(finalColor * (_MainTex_var.a*_Cubemap_var.a*_Opacity),0);
            }
            ENDCG
        }
    }
